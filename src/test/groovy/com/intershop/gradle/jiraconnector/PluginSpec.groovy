...
class PluginSpec extends AbstractProjectSpec {
    ...
    @Override
    Plugin getPlugin() {
        return new JiraConnectorPlugin()
    }

    def 'should add extension named jiraConnector'() {
        when:
        plugin.apply(project)

        then:
        project.extensions.getByName(JiraConnectorExtension.JIRACONNECTOR_EXTENSION_NAME)
    }
}
